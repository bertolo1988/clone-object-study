...
describe.each(funcs)('objects part1', (func) => {
  describe(`🟣 ${func.name} `, () => {
    ...
    it.skip('should clone a non shallow object', () => {
    ...
    it.skip('should clone enumerable properties (same as shallow clone)', () => {
    ...
    it.skip('should clone enumerable and writable properties', () => {
      const input = Object.create(Object.prototype, {
        property1: {
          value: 42,
          enumerable: true,
    ...
    it.skip('should clone non enumerable, non writable and configurable properties', () => {
      const input = Object.create(Object.prototype, {
        property1: {
          value: 42,
          enumerable: false,
    ...
    it.skip('should clone non enumerable, writable and non configurable properties', () => {
      const input = Object.create(Object.prototype, {
        property1: {
          value: 42,
          enumerable: false,
    ...
    it.skip('should clone non enumerable, non writable and non configurable properties', () => {
      const input = Object.create(Object.prototype, {
        property1: {
          value: 42,
          enumerable: false,
    ...
    it.skip('should clone own symbol properties', () => {
    ...
    it.skip('should clone frozen object', () => {
      const input = { foo: 'bar' }
      Object.freeze(input)
      const clone = func(input)
    ...
    it.skip('should clone sealed object', () => {
      const input = { foo: 'bar' }
      Object.seal(input)
      const clone = func(input)
    ...
    it.skip('should clone non extensible object', () => {
      let input = { foo: 'bar' }
    ...
    it.skip('clone typeof should yield same result as the original', () => {
      const input = { foo: 'bar' }
      const clone = func(input)
      assert.equal(typeof clone, typeof input)
    })

    it.skip('should clone the constructor', () => {
      const input = { foo: 'bar' }
      const clone = func(input)
    ...
    describe('prototype', () => {
      ...
      it.skip('clones the __proto__ by really copying', () => {
        const input = { foo: 'bar' }
        let clone = func(input)
      ...
      it.skip('clones non enumerable properties in the prototype', () => {
